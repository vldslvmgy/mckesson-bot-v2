...
app.post('/mckesson', async (req, res) => {
    ...
    const formattedSelection = await parseDaysToSelection(formattedDays, req.body.text);
    const menuString = await printMenuSelection(formattedSelection, req.body.text);
